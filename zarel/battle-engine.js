...
Tools.includeData(); //probably don't need, not sure
Tools.includeFormats(); //probably don't need, not sure
Tools.includeMods(); //this line is very important, it's needed for loading modules in data
...
let Battle = (() => {
	...
	*/
	...
	Battle.prototype.choose = function (sideid, input, rqid) {
		...
		const choices = this.parseChoice(side, input); //todo: buggy?
